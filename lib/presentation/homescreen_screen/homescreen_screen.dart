...
class HomescreenScreen extends GetWidget<HomescreenController> {
  ...
  /// Section Widget
  Widget _buildFortySevenRow() {
    return Padding(
        padding: EdgeInsets.only(left: 8.h, right: 4.h),
        child:
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text("lbl_john_doe".tr, style: CustomTextStyles.displaySmallPrimary),
          CustomImageView(
    ...
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Row(
                ...
                children: [
                  CustomImageView(
                      imagePath: ImageConstant.imgMetricicon1Onprimary,
                      height: 15.v,
                      width: 17.h,
        ...
        child: Container(
            ...
            child: Row(children: [
              ...
              Padding(
                  ...
                  child: Text("lbl_c".tr, style: theme.textTheme.bodyMedium))
            ])));
  }
  ...
  /// Navigates to the trafficlighthomescreenScreen when the action is triggered.
  hsToTLHS() {
    Get.toNamed(
